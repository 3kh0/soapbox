<template>
  ...
  <article>
    <div class="mb-6">
      ...
      <h2 class="text-4xl font-bold mt-2 mb-4 text-dark-50">Breakthrough in Quantum Computing Announced</h2>
      <p class="text-dark-400 text-sm">Published on November 22, 2025 • 5 min read</p>
    </div>

    <!-- Featured image placeholder -->
    <div class="mb-8 aspect-video bg-linear-to-br from-accent-400 to-dark-400 rounded-lg flex items-center justify-center border border-dark-600">
    ...
    <div class="prose prose-invert max-w-none">
      <p class="text-lg leading-relaxed mb-6 text-dark-200">
      ...
      <!-- Key points -->
      <h3 class="text-2xl font-bold mt-8 mb-4 text-dark-50">Key Highlights</h3>
      <ul class="space-y-3 mb-8">
        <li class="flex gap-3">
          <span class="text-accent-400 font-bold">•</span>
          <span>New quantum processor operates at 500 stable qubits with 99.9% accuracy</span>
        </li>
        <li class="flex gap-3">
          <span class="text-accent-400 font-bold">•</span>
          <span>Successfully solved optimization problems 10,000x faster than classical computers</span>
        </li>
        <li class="flex gap-3">
          <span class="text-accent-400 font-bold">•</span>
          <span>Potential applications in drug discovery, materials science, and financial modeling</span>
        </li>
        <li class="flex gap-3">
          <span class="text-accent-400 font-bold">•</span>
          <span>Commercial availability expected within 18-24 months</span>
        </li>
      </ul>

      <!-- Quote section -->
      <blockquote class="border-l-4 border-accent-500 pl-6 py-4 my-8 bg-dark-800 rounded-r-lg">
        <p class="text-dark-100 italic mb-2">
        ...
        <p class="text-accent-400 font-semibold">— Dr. Sarah Chen, Lead Researcher</p>
      </blockquote>
      ...
      <h3 class="text-2xl font-bold mt-8 mb-4 text-dark-50">What This Means</h3>
      <p class="text-dark-200 leading-relaxed mb-6">
