  ...
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      ...
      <button
        ...
        class="px-4 py-2 bg-accent-500 hover:bg-accent-600 text-dark-900 font-semibold rounded-lg transition-colors"
      >
        + New Post
      </button>
    </div>
    ...
    >
      <div class="bg-dark-800 rounded-xl border border-dark-700 max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 space-y-4">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input
              ...
              class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 placeholder-dark-500 focus:outline-none focus:border-accent-500 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 placeholder-dark-500 focus:outline-none focus:border-accent-500 transition-colors resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="10"
              class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 placeholder-dark-500 focus:outline-none focus:border-accent-500 transition-colors resize-none font-mono text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              :value="formatDateForInput(newPost.created_at)"
              @input="(e: any) => newPost.created_at = parseDate(e.target.value)"
              type="date"
              class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 focus:outline-none focus:border-accent-500 transition-colors"
            />
          </div>
        </div>
        ...
        <div class="flex gap-3 justify-end pt-4 border-t border-dark-700">
          <button
            @click="showNewPost = false"
            class="px-4 py-2 text-dark-300 hover:text-dark-100 transition-colors"
          >
            Cancel
          </button>
          <button
    ...
    <div v-if="posts && posts.length" class="space-y-3">
      <div
        v-for="post in posts"
        :key="post.slug"
        class="p-4 bg-dark-800 rounded-lg border border-dark-700 hover:border-dark-600 transition-colors flex items-start justify-between"
      >
        <div class="flex-1 min-w-0">
          ...
          <p class="text-dark-500 text-xs mt-2">slug: <code class="text-accent-400">{{ post.slug }}</code></p>
        </div>
        <div class="flex gap-2 ml-4 flex-shrink-0">
          <button
            @click="selectPost(post)"
            class="px-3 py-1.5 text-sm bg-accent-500/20 text-accent-400 hover:bg-accent-500/30 rounded transition-colors"
          >
            Edit
          </button>
          <button
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 focus:outline-none focus:border-accent-500 transition-colors resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="12"
              class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 focus:outline-none focus:border-accent-500 transition-colors resize-none font-mono text-sm"
            />
          </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-dark-200 text-sm font-semibold mb-2">Published Date</label>
              <input
                :value="formatDateForInput(selectedPost.created_at)"
                @input="(e: any) => selectedPost.created_at = parseDate(e.target.value)"
                type="date"
                class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 focus:outline-none focus:border-accent-500 transition-colors"
              />
            </div>
            <div>
              ...
              <input
                :value="formatDateForInput(selectedPost.updated_at || Math.floor(Date.now() / 1000))"
                @input="(e: any) => selectedPost.updated_at = parseDate(e.target.value)"
                type="date"
                class="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-lg text-dark-100 focus:outline-none focus:border-accent-500 transition-colors"
              />
            </div>
